...
> This section covers guidelines specific to Odoo addons developed by Apik. It includes naming conventions,
> module structure, manifest requirements, model definitions, field usage, and method implementations.
...
- Use **AbstractModel** for **behaviour reuse**, not for storing data.
- Prefer **mixins** to re‑implementing generic features (mail, portal, sequence, rating).
